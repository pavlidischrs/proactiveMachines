...
#Solver and Net
caffe.set_mode_cpu()
model_def='st_mnist_part/lenet.prototxt'
model_weights='st_mnist_part/lenet_iter_1000.caffemodel'
...
img = caffe.io.load_image('../../../Desktop/databases/dis_trs_part/'+str(sys.argv[1])+'.png',color=False)
